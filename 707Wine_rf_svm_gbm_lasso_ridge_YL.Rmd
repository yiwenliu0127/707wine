...
```
```{r}
ggplot(aes(x=points, y=price, col = taster_name), data = data) + geom_jitter()
ggplot(aes(x=points, y=price, col = country), data = data) + geom_jitter() + theme(legend.position = "right")
ggplot(aes(x=points, y=price, col = variety), data = data) + geom_jitter() + theme(legend.position = 'none')
```
...
ggplot(aes(x=points, y=price, col = location), data = clean_train) + geom_jitter() + theme(legend.position = "right")
...
clean_test <- clean_test %>% select(-title, -country)
...
ggplot(aes(x=points, y=price), data = price_pt_df) + geom_point() + geom_point(aes(x=points, y=pred_price), col="red")
ggplot(aes(x=price, y=points), data = price_pt_df) + geom_point() + geom_point(aes(x=price, y=pred_point), col="red")
```
